...
为了克服这个障碍，我们提出了 “ChillDKG”，一种新的 “开箱即用” DKG 协议，为 FROST 的用法量身定制（[草案](https://github.com/BlockstreamResearch/bip-frost-dkg?ref=blog.blockstream.com)）。我们以 BIP 草案的形式提供了详细的描述；而 BIP 本身就旨在成为指导实现者的规范。
