...
此外，代码通常是一次写成，却要被阅读很多次。因此代码的评审是一个重要得多的步骤，因为它会暴露一段代码 “好不好读”。这里的经验法则是，你每发起一次 PR，都需要阅读 3 个 PR。在一开始，你的阅读比例甚至要比 3 更高。
...
请记住，要礼貌、温和及明智。谦逊的态度和学习的愿望，不仅会帮助你成为一个更好的开发者，还会让你成为比特币社区的一股原力。
