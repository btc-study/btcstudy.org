...
> **2024 年 10 月 24 日更新：**
>
> 下文所推荐安装的 EPS 为 0.2.4 版本，已确认无法与 Python 3.12 版本一起工作。在参照以下流程安装及配置 EPS 之前请先检查 EPS 的版本，使用更新的版本。
>
> 如果没有新版本，则运行以下命令，检查本地的 python 版本：
>
> ```
> python --version
> ```
>
> 如果你在使用 Python 3.12 版本，可以考虑使用 [pyenv](https://github.com/pyenv/pyenv)，为电脑安装多个 python 版本、命令 EPS 使用较老版本的 python。
...
>
> **2024 年 10 月 24 日重要补充：**
>
> 在给 EPS 更新完证书之后，你的 Electrum 钱包可能会无法连接 EPS。这可能是因为：如果你此前成功连接过，则 Electrum 钱包会根据 IP 地址记录 EPS 的证书。但如今 EPS 的证书已经改变，两者就无法匹配了。因此，我们需要手动删除 Electrum 钱包存储的旧证书。
>
