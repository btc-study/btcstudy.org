...
如果你对这一密钥派生的技术过程感兴趣，可以看看这篇文章：[BIP32 扩展密钥图解](https://www.btcstudy.org/2023/10/09/bip-32-extended-keys-diagram/)
...
如果你正在尝试找回多签名钱包中的资金，请从上文的概念中寻找线索。最终来说，决定多签名钱包地址的因素是扩展公钥以及公钥的排序。因此，我们可以在支持多签名的软件钱包中导入相关的私钥（或其扩展公钥）、尝试不同的公钥排序，从而尝试找回。
