---
title: '什么是 “序数 NFT”？'
author: '在比特币区块链上铸造非同质代币'
date: '2023/02/22 14:58:35'
cover: ''
excerpt: 'Colin Harper'
categories:
- 比特币主网
tags:
- Ordinals
...
“附加铭文的交易是 taproot 输出的花费交易，会将相应的 tapscript 暴露出来，因此铭文的内容和文件类型也会暴露出来”，序数 NFT 的常使人 Casey Rodarmor 在一次手机访谈中说，“铭文会 ‘附着’ 在这样的交易的第一个输出的第一个聪上 …… 然后序数协议允许你使用普通的比特币交易转移这些聪。”
...
“我不会称这是一场意外 —— 我觉得人们会为此感到惊喜”，Radarmor 说。
...
还需要提醒的是：被附加了铭文的聪，从链上来看跟其它聪依然是没有分别的，意思是它就跟其它聪一样是可以花费的，而且花费方式也没有区别。现在，一个聪只能铭刻一次，但 Rudarmor 正在开发一种升级，让用户可以重新铭刻之前已经铭刻过的聪（叫做 “抄写”）。
